"""
This is taken almost directly from https://triton-lang.org/main/getting-started/tutorials/01-vector-add.html#sphx-glr-getting-started-tutorials-01-vector-add-py
...
def add_many_kernel(x_ptr,  # *Pointer* to first input vector.
    ...
    output = x + y + y + y + y + y + y + y + y + y
    # Write x + y back to DRAM.
    tl.store(output_ptr + offsets, output, mask=mask)


def add_many(x: torch.Tensor, y: torch.Tensor):
